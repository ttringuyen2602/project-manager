...
public:
    ...
    void removeDrink(int typeOfDrink, int thisDrink, int numberOf, int rateOfIce, int rateOfSugar); // Xóa đồ uống nếu lỡ gọi nhầm
    void removeAllDrink();
};
...
//, string name, int numberOf
void Table::removeDrink(int typeOfDrink, int thisDrink, int numberOf, int rateOfIce, int rateOfSugar)
{
    switch (typeOfDrink)
    {
    case 1: // Tea
